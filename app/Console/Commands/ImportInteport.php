...
class ImportInteport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'import:interport {file}';
     ...
     * @var string
     */
    protected $description = 'Import interport geojson into db';
     ...
     */
     ...
     public function handle()
     {
         ...
         $this->info('Interport GeoJSON data imported successfully.');
     }
